...
//  Compress 512-bits
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static void TransformFunction(struct Sha256Context* Context, uint8_t const* Buffer) {
  uint32_t S[8];
  uint32_t W[64];
  uint32_t t0;
  uint32_t t1;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void Sha256Initialise(struct Sha256Context* Context  // [out]
) {
  Context->curlen = 0;
  Context->length = 0;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void Sha256Update(struct Sha256Context* Context,  // [in out]
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void Sha256Finalise(struct Sha256Context* Context,  // [in out]
                    struct SHA256_HASH* Digest      // [out]
) {
  int i;
